...
import "./BasicAdjuncts.css";
import htcl from './images/head-tilt-chin-lift.jpg';
import jwt from './images/jaw-thrust.png';
import suction from './images/suctioning.jpg';
import opa from './images/OPA.jpeg';
import npa from './images/NPA.jpg';
import bvm from './images/bvm.jpg';
import sellick from './images/sellick.jpg';
            ...
            <div className="basics-container">
                ...
                <div className="basics-subs">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('headTilt')} className="basics-btn">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('jawThrust')} className="basics-btn">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('suction')} className="basics-btn">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('opa')} className="basics-btn">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('npa')} className="basics-btn">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('bvm')} className="basics-btn">
                    ...
                    <div className='basics-image'>
                        <button onClick={() => toggleVisibility('sellick')} className="basics-btn">
