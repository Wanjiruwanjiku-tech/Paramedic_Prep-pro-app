...
import tamponade from './images/tamponade.jpg';
import per from './images/pe.jpg';
import MI from './images/mi.jpg';
import hyper from './images/hypertensive.jpg';
import CHF from './images/chf.jpg';
import cardio from './images/cardiogenic.jpg';
import CA from './images/ca.jpg';
import aortic from './images/aortic.png';
import AF from './images/af.jpg';
import ACS from './images/acs.png';

const CardiacModuleOutcomes = () => {
    const outcomes = [
      'Recognition of Cardiac Emergencies.',
      'Understanding Cardiac Pathophysiology.',
      'Understand the Initial Assessment and Management.',
      'Application of ACLS Protocols.',
      'Execution of High-Quality CPR as well as Defibrillation and Cardioversion.',
      'Post-Cardiac Arrest Care.',
      'Communication and Team Dynamics.',
    ];
  
    return (
      <div className="cardiac-module-outcomes">
        <h1>Learning Outcomes: Cardiac Emergencies</h1>
        <ul className="cardiac-outcomes-list">
          {outcomes.map((outcome, index) => (
            <li key={index} className="cardiac-outcome-item">{outcome}</li>
          ))}
        </ul>
      </div>
    );
